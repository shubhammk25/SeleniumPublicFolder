...
public class Reg_User_01 {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		rv.findElement(By.xpath("//*[@id=\"form\"]/div/div/div[3]/div/form/input[2]")).sendKeys("Vinayak k");Thread.sleep(2000);
		rv.findElement(By.cssSelector("#form > div > div > div:nth-child(3) > div > form > input[type=email]:nth-child(3)")).sendKeys("vinuu1223@gmail.com");
		Thread.sleep(2000);
		...
		WebElement checkbox1=rv.findElement(By.name("newsletter"));checkbox1.click();Thread.sleep(3000);
		...
		Thread.sleep(2000);
		//first_name filed
		rv.findElement(By.id("first_name")).sendKeys("Vinayak");Thread.sleep(2000);
		//last_name filed
		rv.findElement(By.name("last_name")).sendKeys("k");Thread.sleep(2000);
		//company filed
		...
		//mobile_number
		rv.findElement(By.cssSelector("#mobile_number")).sendKeys("1234568899");Thread.sleep(2000);
		// click on create button
		rv.findElement(By.xpath(".//button[contains(text(),'Create Account')]")).click();Thread.sleep(2000);
		//click on countinue
		rv.findElement(By.xpath(".//a[@class='btn btn-primary']")).click();Thread.sleep(5000);
		//verify user logged in User name
		WebElement userName = rv.findElement(By.xpath(".//a[contains(.,'Logged in as')]//b[.='Vinayak k']"));Thread.sleep(2000);
		String output = userName.getText();
		
		if (output.contains("Vinayak k")) {
		...
		Thread.sleep(5000);
		if (text.getText().contains(DeleteText)) {
